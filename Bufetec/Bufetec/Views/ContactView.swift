...
struct ContactView: View {
    ...
    var body: some View {
        NavigationStack { // Wrap everything inside a NavigationStack for navigation
            ZStack {
                // Background gradient
                ...
                VStack {
                    ...
                    // NavigationLink replacing the Button to navigate to MainPageView
                    ...
                    .simultaneousGesture(TapGesture().onEnded {
                        sendMessage() // Call sendMessage when the button is tapped
                    })
